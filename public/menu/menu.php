...
@media (min-width: 62em) {
    ...
    #dropdown1{height: unset;font-size: 13px;font-weight: bold;line-height: 2;width: 238px;background:white;border-radius:13px}
    #dropdown2{height: unset;font-size: 38px;font-weight: bold;line-height: 2;width: 238px;background:white;border-radius:13px}
...
@media (min-width: 75em) {
   #barraMenu{margin:0;width: 100%;background: white; min-height: 80px;margin:0px;box-shadow: 4px 7px 14px #888888;position:fixed; z-index: 100;}
    ...
    #contenedor-perfil1{display: block;background: white;padding: 10px;border-radius: 10px;width: 250px;margin-right:0px;margin-top:0px;}
    #contenedor-perfil2{display: block;background: white;padding: 10px;border-radius: 10px;width: 250px;margin-right:0px;margin-top:0px;}
    #dropdown1{color:gray;height: unset;font-size: 13px;font-weight: bold;line-height: 2;width: 238px;background:white;border-radius:13px}
    #dropdown2{color:gray;height: unset;font-size: 13px;font-weight: bold;line-height: 2;width: 238px;background:white;border-radius:13px}
    #contenedor-animation{margin:0;margin-top:0px;}
    #img-animation{ width: 100%; height:290px;}
    #form-busqueda{width:100%;}
    #select-categoria{height: 47px; font-size: 15px; font-weight: bold;background: #e4e4e4;width: 200px;}
                    ...
                    <table style="border-style:none">
                        <td>
                              ...
                              <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu" id="dropdown" style="margin-left: -220px;border-radius: 15px;" >
                                    ...
                                    $chatsNuevos = Chat::where('idUser', '=', $user[0]['id'])->where('visto', '=', 0)->get();
                                       ...
                                       <div class="dropdown-item"><a href="/specialistMsj"><div id="notificacionMensaje" style="font-size:12px;width:260px" class="alert alert-info"><span style="font-size: 11px;"><?php echo $chatsNuevos[$i]['created_at']?></span><br><br><strong><?php echo $specialist[0]['name'] . ' ' .  $specialist[0]['lastName'] ?></strong> Te habló por el problema <br> de <strong><a style="color:#0c5460" href="/userMsj"><?php echo $problema[0]['specialty'] ?></a></strong> </div></a></div>
                                ...
                                <div class="dropdown-menu" id="dropdown" style="margin-left: -220px;" >
                                    ...
                                    $chatsNuevos = Chat::where('idSpecialist', '=', $specialist[0]['id'])->where('vistoSpecialist', '=', 0)->get();
                                        for($i=0; $i<count($chatsNuevos);$i++){
                                            ...
                                            <div class="dropdown-item"><div id="notificacionMensaje" style="font-size:12px;width:260px" class="alert alert-info"><span style="font-size: 11px;"><img style="height:37px;width:37px; border-radius:20px;" height="15" src="<?php echo $user[0]['ruta'] ?>"/><strong><?php echo '   ' . $user[0]['name'] . ' ' .  $user[0]['lastName']  . ' '?></strong><span style="color:#989898;;text-align:right;"><?php echo $chatsNuevos[$i]['created_at']?></span></span><br><br><strong><?php echo $user[0]['name'] ?></strong> Te habló por el problema <br> de <strong><a style="color:#0c5460" href="/specialistMsj"><?php echo $problema[0]['specialty'] ?></a></strong> </div></div>
                                            <div class="dropdown-divider"></div>
